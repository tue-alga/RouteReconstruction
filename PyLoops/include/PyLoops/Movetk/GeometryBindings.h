...
namespace PyLoops::movetk
{
    ...
    public:
        ...
        static void registerPy(pybind11::module& mod)
        {
            ...
            pybind11::class_<LoopsLib::MovetkGeometryKernel::MovetkPoint>(mod, "MtkPoint")
                .def("x", &LoopsLib::MovetkGeometryKernel::MovetkPoint::x)
                .def("y", &LoopsLib::MovetkGeometryKernel::MovetkPoint::y);
            using TimedPoint = std::pair<LoopsLib::MovetkGeometryKernel::MovetkPoint, LoopsLib::NT>;
            pybind11::class_<TimedPoint>(mod, "MtkTimedPoint")
                .def("x", [](const TimedPoint& t) {return t.first.x(); })
                .def("y", [](const TimedPoint& t) {return t.first.y(); })
                .def("t", [](const TimedPoint& t) {return t.second; })
            ;
        }
    };
}
