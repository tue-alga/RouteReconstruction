#include <PyLoops/Bindings/loops/PyDecompositionAlgs.h>
...
void PyLoops::Bindings::PyDecompositionAlgs::registerPy(pybind11::module& mod)
{
    ...
    using SPD = LoopsAlgs::FlowDecomposition::ShortestPathsDecomposition;
    bindDecompositionAlgorithm(detail::TypeHolder<SPD>{}, mod, "WidestPathDecomposition"
    );
