...
void PyLoops::frechet::PyStrongFrechetGraphData::registerPy(pybind11::module& mod)
{
    ...
    pybind11::class_<GD>(mod, "StrongFrechetGraphData")
        ...
        .def("setup", [](GD& gd, LoopsLib::DS::EmbeddedGraph* g, const LoopsLib::MovetkGeometryKernel::Trajectory& path)
        {
            gd.setup(g, path);
        })
    ...
    .def("cellIntervalsForEdgeGlobalVs", [](const GD& gd, std::size_t startVert, std::size_t endVert, bool throwOnUnavailable)
    {
        ...
        return returnValues;
    },py::arg("startVert"),py::arg("endVert"), py::arg("throwOnUnavailable")=true)
